export default {
  ...
  projects: [
    ...
    },
    {
      id: 4,
      title: 'Notes App',
      desc: 'This is probably the most complex project listed but it was worth the effort. This note app takes advantage of React hooks like State and Effect as well as utilizing the local storage of the browser. Try taking some notes and come back to them!',
      link: '#',
      image: '',
      type: 'project',
    },
